  ...
  return (
    <div className='w-full'>
        <div className='max-w-7xl mx-auto px-4 lg:px-6 py-12'>
            ...
            <span className='relative w-5 h-5 mr-2 flex items-center justify-center'>
            <img className='absolute inset-0 w-full h-full object-contain block group-hover:hidden' src={archives} alt="" />
            <img className='absolute inset-0 w-full h-full object-contain hidden group-hover:block' src={hoverArchives} alt="" />
            </span>
            Browse Archives
            </button>
            </div>
